...
n_hybrid, avg_comp_hybrid, avg_swaps_hybrid = process_data("hybrid.txt")
...
plt.plot(n_hybrid, avg_comp_hybrid, label="Hybrid Sort", marker="o")
plt.xlabel("n")
...
plt.plot(n_hybrid, avg_swaps_hybrid, label="Hybrid Sort", marker="o")
plt.xlabel("n")
...
plt.plot(n_hybrid, [comp / n for n, comp in zip(n_hybrid, avg_comp_hybrid)], label="Hybrid Sort", marker="o")
plt.xlabel("n")
...
plt.plot(n_hybrid, [comp / n for n, comp in zip(n_hybrid, avg_swaps_hybrid)], label="Hybrid Sort", marker="o")
plt.xlabel("n")
